...
int main() {
   ...
   * Set Measurements
   */
  vector<MeasurementPackage> measurement_pack_list; //无用？
  ...
  int size_E = estimations.size();
  int size_G = ground_truth.size();
  cout <<  "size estimations: " << size_E << endl;
  cout <<  "size ground_truth: " << size_G << endl;
